...
public class Home extends JFrame{
    ...
    public Home(String username) {
        super("Travel and Tourism booking System");
	this.username = username;
        setForeground(Color.CYAN);
        setLayout(null); 

        
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("travel/booking/system/icons/home.jpg"));
	...
	NewLabel.setBounds(0, 0, 1950, 1000); 
        ...
        JLabel l1 = new JLabel("Travel and Tourism booking System");
